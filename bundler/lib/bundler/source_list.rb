...
module Bundler
  class SourceList
    ...
    def lock_other_sources
      (path_sources + git_sources + plugin_sources).sort_by(&:sort_obj)
    end
    ...
    def lock_rubygems_sources
      if merged_gem_lockfile_sections?
        ...
        rubygems_sources.sort_by(&:sort_obj)
      end
    end
    ...
    def equal_sources?(lock_sources, replacement_sources)
      lock_sources.sort_by(&:sort_obj) == replacement_sources.sort_by(&:sort_obj)
    end
